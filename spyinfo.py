...
about = ("""
 Эта утилита разработана компанией Program Global.
 ...
 Чтобы узнать какую функцию преобрела утитилита после обновления, напишите 4 в терминал запущенной утилитыl""")
