...
def about():
  	print("""\033[36m
 Эта утилита разработана Львом Цхай и Богданом Октябрьским.
...
\033[33m 	КАК ИСПОЛЬЗОВАТЬ?
 ...
 Чтобы узнать местоположение IP, введите 2, введите IP. На данный момент мы разрабатываем функцию, через которую проще будет узнать IP - адрес чужого телефона.
 	...
 	ПОДВОДНЫЕ КАМНИ!!!
 	\033[36m
 Если телефон подключён к интернету/WiFi, то вы узнаете не местополодение телефона, а местонахождение роутера. Чтобы определить точный IP - адрес, нужно
